...
namespace 符号化.Annotation
{
    public partial class frmAnnotation : Form
    {
        ...
        public delegate void AnnotationEventHandler(string sFeatClsName, string sFieldName);
        public event AnnotationEventHandler Annotation = null;
        ...
        {
            if (!check()) return;           
            Annotation(cmbSelLyr.SelectedItem.ToString(), cmbSelField.SelectedItem.ToString());
            cmbSelField.Items.Clear();
            cmbSelField.Text = "";
